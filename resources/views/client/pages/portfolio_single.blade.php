        ...
        <div class="row">
          <div class="col-md-7">
            ...
            <div class="custom-breadcrumbs">
              ...
              <a href="{{route('client.portfolio')}}">Portfolio</a> <span class="mx-2 slash">/</span>
    ...
    <section class="site-section pb-0 portfolio-single" id="next-section">
      ...
      <div class="container">
        ...
        <div class="row mb-5 mt-5">
          ...
          <div class="col-lg-8">
            <figure>
              <a href="{{ asset('client/images/sq_img_6.jpg') }}" data-fancybox="gallery"><img src="{{ asset('client/images/sq_img_6.jpg') }}" alt="Image" class="img-fluid"></a>
            </figure>
            <figure>
              <a href="{{ asset('client/images/sq_img_2.jpg') }}" data-fancybox="gallery"><img src="{{ asset('client/images/sq_img_2.jpg') }}" alt="Image" class="img-fluid"></a>
            </figure>
            <figure>
              <a href="{{ asset('client/images/sq_img_7.jpg') }}" data-fancybox="gallery"><img src="{{ asset('client/images/sq_img_7.jpg') }}" alt="Image" class="img-fluid"></a>
            </figure>
            <figure class="mb-0">
              <a href="{{ asset('client/images/sq_img_8.jpg') }}" data-fancybox="gallery"><img src="{{ asset('client/images/sq_img_8.jpg') }}" alt="Image" class="img-fluid"></a>
            </figure>
          </div>
