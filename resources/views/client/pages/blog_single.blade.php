      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 blog-content">
            ...
            <p><img src="{{ asset('client/images/job_single_img_1.jpg') }}" alt="Image" class="img-fluid rounded"></p>
            ...
            <div class="pt-5">
              ...
              <ul class="comment-list">
                <li class="comment">
                  <div class="vcard bio">
                    <img src="{{ asset('client/images/person_2.jpg') }}" alt="Image placeholder">
                  </div>
                ...
                <li class="comment">
                  <div class="vcard bio">
                    <img src="{{ asset('client/images/person_3.jpg') }}" alt="Image placeholder">
                  </div>
                  <div class="comment-body">
                    <h3>Chris Meyer</h3>
                    <div class="meta">January 9, 2018 at 2:21pm</div>
                  ...
                  <ul class="children">
                    <li class="comment">
                      <div class="vcard bio">
                        <img src="{{ asset('client/images/person_5.jpg') }}" alt="Image placeholder">
                      </div>
                      <div class="comment-body">
                        <h3>Chintan Patel</h3>
                        <div class="meta">January 9, 2018 at 2:21pm</div>
                      ...
                      <ul class="children">
                        <li class="comment">
                          <div class="vcard bio">
                            <img src="{{ asset('client/images/person_1.jpg') }}" alt="Image placeholder">
                          </div>
                          <div class="comment-body">
                            <h3>Jean Doe</h3>
                            <div class="meta">January 9, 2018 at 2:21pm</div>
                            ...
                            <ul class="children">
                              <li class="comment">
                                <div class="vcard bio">
                                  <img src="{{ asset('client/images/person_4.jpg') }}" alt="Image placeholder">
                                </div>
                                <div class="comment-body">
                                  <h3>Ben Afflick</h3>
                                  <div class="meta">January 9, 2018 at 2:21pm</div>
          ...
          <div class="col-lg-4 sidebar pl-lg-5">
            ...
            <div class="sidebar-box">
              <img src="{{ asset('client/images/person_1.jpg') }}" alt="Image placeholder" class="img-fluid mb-4 w-50 rounded-circle">
